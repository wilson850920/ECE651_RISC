...
/**
 * Precompiled edu.duke.ece651.risc.java-application-conventions script plugin.
 **/
public class EduDukeEce651RiscJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EduDukeEce651RiscJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("edu.duke.ece651.risc.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduDukeEce651RiscJavaApplicationConventions").asSubclass(BasicScript.class);
