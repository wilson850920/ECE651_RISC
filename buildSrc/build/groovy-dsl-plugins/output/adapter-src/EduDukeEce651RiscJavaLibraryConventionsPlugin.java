...
/**
 * Precompiled edu.duke.ece651.risc.java-library-conventions script plugin.
 **/
public class EduDukeEce651RiscJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EduDukeEce651RiscJavaLibraryConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduDukeEce651RiscJavaLibraryConventions").asSubclass(BasicScript.class);
