...
/**
 * Precompiled edu.duke.ece651.risc.java-common-conventions script plugin.
 **/
public class EduDukeEce651RiscJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_EduDukeEce651RiscJavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_EduDukeEce651RiscJavaCommonConventions").asSubclass(BasicScript.class);
